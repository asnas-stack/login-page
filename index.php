...
<body>
    <nav class="navbar navbar-expand-sm bg-custom navbar-custom">
        <a class="navbar-brand" href="#">
            <img src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/12_qg5y3o.png" alt="Logo" style="width:25vw;" class="ml-5 mr-3">
        </a>
        <form class="form-inline" action="/action_page.php" class="">
    ...
    <div class="container-fluid" style="background-color: #000;">
        <img class="img-fluid" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/all_iPhoneprismabanner_j57zdl.jpg">
    </div>
    ...
    <div class="container-fluid" style="background-color: #fff;">
        ...
        <div class="row">
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <img class="card-img-top" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/1_hwghoy.jpg" alt="Card image">
                        <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <img class="card-img-top" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/1-2_zp52ft.jpg" alt="Card image">
                        <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <img class="card-img-top" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/1-3_qni3ob.jpg" alt="Card image">
                        <div class="card-body">
            ...
            <div class="col-md-3">
                <a href="">
                    <div class="card">
                        <img class="card-img-top" src="https://res.cloudinary.com/sgnolebagabriel/image/upload/v1568791926/1-4_pjsklv.jpg" alt="Card image">
                        <div class="card-body">
